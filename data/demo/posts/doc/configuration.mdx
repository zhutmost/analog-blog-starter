...
Note that if your site is hosted on a subdirectory, you also need to set the environment variable `BASE_PATH` to the subdirectory path, such as `/blog`. This is required by Next.js to ensure that the routing works correctly.
