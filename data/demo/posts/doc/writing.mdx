...
|----------------|-----------------------------|-----------------|--------------------------------------|
| Blog Posts     | `/data/posts/[slug].mdx`    | `/post/[slug]`  | `/src/templates/post-template.tsx`   |
| Default Author | `/data/authors/default.mdx` | `/about`        | `/src/templates/author-template.tsx` |
| Authors        | `/data/authors/[slug].mdx`  | `/about/[slug]` | `/src/templates/author-template.tsx` |
| General Pages  | `/data/pages/[slug].mdx`    | `/[slug]`       | `/src/templates/page-template.tsx`   |
